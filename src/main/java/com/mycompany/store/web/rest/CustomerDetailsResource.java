...
import com.mycompany.store.repository.CustomerDetailsRepository;
import com.mycompany.store.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link com.mycompany.store.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
