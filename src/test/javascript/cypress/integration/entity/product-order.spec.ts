...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { quantity: 74076, totalPrice: 30942 };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/products',
      body: {"sku":"compress Account bandwidth","upc":"Bacon models","name":"Pants capacitor","description":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=","price":53068,"productSize":"S","colors":"f,on,l,iq,lb,dc","image":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","imageContentType":"unknown","imageSha1":"67e84920031ef64538d7c476a4f83f6e6de347e6","imageCdnUrl":"Berkshire GB optical","thumbnailSha1":"3384fbf2feaa588fd02e9c2fb087de7f1e608650","thumbnailCdnUrl":"Sports infomediaries copy"},
    }).then(({ body }) => {
      product = body;
    });
    // create an instance at the required relationship entity:
    cy.authenticatedRequest({
      ...
      body: {"placedDate":"2021-12-09T17:15:40.059Z","status":"PENDING","totalPrice":72121,"paymentMethod":"CREDIT_CARD","paymentReference":"matrix Dynamic"},
    }).then(({ body }) => {
      shoppingCart = body;
    });
  });
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="quantity"]`).type('23794').should('have.value', '23794');

      cy.get(`[data-cy="totalPrice"]`).type('51719').should('have.value', '51719');
